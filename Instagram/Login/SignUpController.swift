...
class SignUpController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    let alreadyHaveAccountButton: UIButton = {
        ...
        let attributedTitle = NSMutableAttributedString(string: "Already have an account?  ", attributes: [NSAttributedStringKey.foregroundColor: UIColor.lightGray, NSAttributedStringKey.font: UIFont.boldSystemFont(ofSize: 14)])
    ...
    @objc func handleAlreadyHaveAccount() {
        ...
        // _ = navigationController?.popViewController(animated: true) to fix compiler error.
    }
